...
Shader "ASESampleShaders/CustomLightingToon"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 temp_output_23_0 = ( ( tex2D( _Diffuse, uv_Diffuse ) * tex2D( _ToonRamp, temp_cast_0 ) ) * ( ase_lightColor * float4( ( indirectDiffuse11 + ase_lightAtten ) , 0.0 ) ) );
			c.rgb = temp_output_23_0.rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=15600
630;100;874;554;450.368;326.8311;2.146955;True;False
...
ASEEND*/
//CHKSM=700D2E6B2A739DC7EE7CE807B0766BA4344A4227